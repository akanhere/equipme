...
namespace EquipMe.Services.RequestProvider
{
    public class RequestProviderService : IRequestProviderService
    {
        ...
        public async Task<TResult> GetAsync<TResult>(string uri, string token = "")
        {
            ...
            await RequestProviderService.HandleResponse(response).ConfigureAwait(false);
        ...
        public async Task<TResult> PostAsync<TResult>(string uri, TResult data, string token = "", string header = "")
        {
            ...
            {
                RequestProviderService.AddHeaderParameter(httpClient, header);
            }
        ...
        public async Task<TResult> PostAsync<TResult>(string uri, string data, string clientId, string clientSecret)
        {
            ...
            {
                RequestProviderService.AddBasicAuthenticationHeader(httpClient, clientId, clientSecret);
            }
